...
enable_email_alerts = st.sidebar.toggle("Send email alerts", value=False, help="Requires SMTP secrets in Streamlit settings.")
    ...
    with col_b:
        if st.button("Capture test alert"):
            add_in_app_alert({
                ...
                "Extras": {"fib_tp1": 1.23, "liquidity_phase": "RTH", "htf_bias_value": "BULL", "bull_breaker_retest": True}
            })
